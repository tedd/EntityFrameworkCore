...
namespace Microsoft.EntityFrameworkCore
{
    public class TdServerEndToEndTest : IClassFixture<TdServerFixture>
    {
        ...
        public TdServerEndToEndTest(TdServerFixture fixture)
        {
            Fixture = fixture;
        ...
        {
            using (var testStore = TdServerTestStore.GetNorthwindStore())
            {
        ...
        {
            using (var testStore = TdServerTestStore.CreateInitialized(DatabaseName))
            {
