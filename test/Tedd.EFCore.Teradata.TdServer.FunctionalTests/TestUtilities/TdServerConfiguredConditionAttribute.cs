...
namespace Microsoft.EntityFrameworkCore.TestUtilities
{
    ...
    public sealed class TdServerConfiguredConditionAttribute : Attribute, ITestCondition
    {
        private static readonly string _dataSource =
            new TdConnectionStringBuilder(TdServerTestStore.CreateConnectionString("sample")).DataSource;
