...
{
    public class TdServerUpdateSqlGeneratorTest : UpdateSqlGeneratorTestBase
    {
        protected override IUpdateSqlGenerator CreateSqlGenerator()
            => new TdServerUpdateSqlGenerator(
                new UpdateSqlGeneratorDependencies(
                    ...
                    new TdServerTypeMappingSource(
                        TestServiceFactory.Instance.Create<TypeMappingSourceDependencies>(),
                        TestServiceFactory.Instance.Create<RelationalTypeMappingSourceDependencies>())));

        protected override TestHelpers TestHelpers => TdServerTestHelpers.Instance;
...
",
        ...
        public void AppendBulkInsertOperation_appends_insert_if_store_generated_columns_exist()
        {
            ...
            var sqlGenerator = (ITdServerUpdateSqlGenerator)CreateSqlGenerator();
