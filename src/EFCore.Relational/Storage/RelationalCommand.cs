...
namespace Microsoft.EntityFrameworkCore.Storage
{
    ...
    public class RelationalCommand : IRelationalCommand
    {
        ...
        public virtual int ExecuteNonQuery(RelationalCommandParameterObject parameterObject)
        {
            ...
            var command = CreateCommand(parameterObject, parameterObject.ParameterValues, commandId, DbCommandMethod.ExecuteNonQuery);
        ...
        public virtual object ExecuteScalar(RelationalCommandParameterObject parameterObject)
        {
            ...
            var commandId = Guid.NewGuid();
            var command = CreateCommand(parameterObject, parameterObject.ParameterValues, commandId, DbCommandMethod.ExecuteScalar);
        ...
        public virtual RelationalDataReader ExecuteReader(RelationalCommandParameterObject parameterObject)
        {
            ...
            var commandId = Guid.NewGuid();
            var command = CreateCommand(parameterObject, parameterObject.ParameterValues, commandId, DbCommandMethod.ExecuteReader);
