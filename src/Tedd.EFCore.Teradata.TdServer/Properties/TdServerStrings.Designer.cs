...
using Tedd.EFCore.Teradata.TdServer;
...
namespace Tedd.EFCore.Teradata.TdServer.Internal
{
    ...
    /// </summary>
    public static class TdServerStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Microsoft.EntityFrameworkCore.TdServer.Properties.TdServerStrings", typeof(TdServerStrings).GetTypeInfo().Assembly);
        ...
        /// <summary>
        ///     An exception has been raised that is likely due to a transient failure. Consider enabling transient error resiliency by adding 'EnableRetryOnFailure()' to the 'UseTdServer' call.
        /// </summary>
...
namespace Microsoft.EntityFrameworkCore.TdServer.Internal
{
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static class TdServerResources
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Microsoft.EntityFrameworkCore.TdServer.Properties.TdServerStrings", typeof(TdServerResources).GetTypeInfo().Assembly);
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogDefaultDecimalTypeColumn;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogDefaultDecimalTypeColumn,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        TdServerEventId.DecimalTypeDefaultWarning,
                        LogLevel.Warning,
                        "TdServerEventId.DecimalTypeDefaultWarning",
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogByteIdentityColumn;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogByteIdentityColumn,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        TdServerEventId.ByteIdentityColumnWarning,
                        LogLevel.Warning,
                        "TdServerEventId.ByteIdentityColumnWarning",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogFoundDefaultSchema;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogFoundDefaultSchema,
                    () => new EventDefinition<string>(
                        logger.Options,
                        TdServerEventId.DefaultSchemaFound,
                        LogLevel.Debug,
                        "TdServerEventId.DefaultSchemaFound",
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogFoundTypeAlias;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogFoundTypeAlias,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        TdServerEventId.TypeAliasFound,
                        LogLevel.Debug,
                        "TdServerEventId.TypeAliasFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogFoundColumn;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogFoundColumn,
                    () => new FallbackEventDefinition(
                        logger.Options,
                        TdServerEventId.ColumnFound,
                        LogLevel.Debug,
                        "TdServerEventId.ColumnFound",
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogFoundForeignKey;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogFoundForeignKey,
                    () => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        TdServerEventId.ForeignKeyFound,
                        LogLevel.Debug,
                        "TdServerEventId.ForeignKeyFound",
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogPrincipalTableNotInSelectionSet;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogPrincipalTableNotInSelectionSet,
                    () => new EventDefinition<string, string, string>(
                        logger.Options,
                        TdServerEventId.ForeignKeyReferencesMissingPrincipalTableWarning,
                        LogLevel.Warning,
                        "TdServerEventId.ForeignKeyReferencesMissingPrincipalTableWarning",
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogMissingSchema;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogMissingSchema,
                    () => new EventDefinition<string>(
                        logger.Options,
                        TdServerEventId.MissingSchemaWarning,
                        LogLevel.Warning,
                        "TdServerEventId.MissingSchemaWarning",
                        level => LoggerMessage.Define<string>(
                            level,
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogMissingTable;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogMissingTable,
                    () => new EventDefinition<string>(
                        logger.Options,
                        TdServerEventId.MissingTableWarning,
                        LogLevel.Warning,
                        "TdServerEventId.MissingTableWarning",
                        level => LoggerMessage.Define<string>(
                            level,
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogFoundSequence;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogFoundSequence,
                    () => new FallbackEventDefinition(
                        logger.Options,
                        TdServerEventId.SequenceFound,
                        LogLevel.Debug,
                        "TdServerEventId.SequenceFound",
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogFoundTable;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogFoundTable,
                    () => new EventDefinition<string>(
                        logger.Options,
                        TdServerEventId.TableFound,
                        LogLevel.Debug,
                        "TdServerEventId.TableFound",
                        level => LoggerMessage.Define<string>(
                            level,
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogFoundIndex;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogFoundIndex,
                    () => new EventDefinition<string, string, bool>(
                        logger.Options,
                        TdServerEventId.IndexFound,
                        LogLevel.Debug,
                        "TdServerEventId.IndexFound",
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogFoundPrimaryKey;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogFoundPrimaryKey,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        TdServerEventId.PrimaryKeyFound,
                        LogLevel.Debug,
                        "TdServerEventId.PrimaryKeyFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogFoundUniqueConstraint;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogFoundUniqueConstraint,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        TdServerEventId.UniqueConstraintFound,
                        LogLevel.Debug,
                        "TdServerEventId.UniqueConstraintFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogPrincipalColumnNotFound;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogPrincipalColumnNotFound,
                    () => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        TdServerEventId.ForeignKeyPrincipalColumnMissingWarning,
                        LogLevel.Warning,
                        "TdServerEventId.ForeignKeyPrincipalColumnMissingWarning",
                        level => LoggerMessage.Define<string, string, string, string>(
                            level,
        ...
        {
            var definition = ((TdServerLoggingDefinitions)logger.Definitions).LogReflexiveConstraintIgnored;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((TdServerLoggingDefinitions)logger.Definitions).LogReflexiveConstraintIgnored,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        TdServerEventId.ReflexiveConstraintIgnored,
                        LogLevel.Debug,
                        "TdServerEventId.ReflexiveConstraintIgnored",
                        level => LoggerMessage.Define<string, string>(
                            level,
