...
namespace Tedd.EFCore.Teradata.TdServer.Update.Internal
{
    ...
    /// </summary>
    public class TdServerModificationCommandBatch : AffectedCountModificationCommandBatch
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public TdServerModificationCommandBatch(
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        protected new virtual ITdServerUpdateSqlGenerator UpdateSqlGenerator => (ITdServerUpdateSqlGenerator)base.UpdateSqlGenerator;
