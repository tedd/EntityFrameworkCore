...
namespace Tedd.EFCore.Teradata.Metadata.Conventions
{
    ...
    /// </summary>
    public class TdServerMemoryOptimizedTablesConvention :
        IEntityTypeAnnotationChangedConvention,
        IKeyAddedConvention,
        IIndexAddedConvention
    {
        /// <summary>
        ///     Creates a new instance of <see cref="TdServerMemoryOptimizedTablesConvention" />.
        /// </summary>
        /// <param name="dependencies"> Parameter object containing dependencies for this convention. </param>
        /// <param name="relationalDependencies">  Parameter object containing relational dependencies for this convention. </param>
        public TdServerMemoryOptimizedTablesConvention(
        ...
        {
            if (keyBuilder.Metadata.DeclaringEntityType.GetTdServerIsMemoryOptimized())
            {
                keyBuilder.ForTdServerIsClustered(false);
            }
        }
        ...
        {
            if (indexBuilder.Metadata.DeclaringEntityType.GetAllBaseTypesInclusive().Any(et => et.GetTdServerIsMemoryOptimized()))
            {
                indexBuilder.ForTdServerIsClustered(false);
            }
        }
    }
}
