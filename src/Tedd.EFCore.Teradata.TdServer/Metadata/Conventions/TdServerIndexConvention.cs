...
namespace Tedd.EFCore.Teradata.Metadata.Conventions
{
    ...
    /// </summary>
    public class TdServerIndexConvention :
        ...
        IPropertyAnnotationChangedConvention
    {
        ...
        {
            if (name == TdServerAnnotationNames.Clustered)
            {
                SetIndexFilter(indexBuilder);
            }
        }
        ...
        private IConventionIndexBuilder SetIndexFilter(IConventionIndexBuilder indexBuilder, bool columnNameChanged = false)
        {
            ...
            if (index.IsUnique
                && index.GetTdServerIsClustered() != true
                && index.Properties
