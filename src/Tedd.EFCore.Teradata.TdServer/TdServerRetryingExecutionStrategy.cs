...
namespace Tedd.EFCore.Teradata
{
    ...
    ///     on SQL Server.
    /// </summary>
    public class TdServerRetryingExecutionStrategy : ExecutionStrategy
    {
        private readonly ICollection<int> _additionalErrorNumbers;

        /// <summary>
        ///     Creates a new instance of <see cref="TdServerRetryingExecutionStrategy" />.
        /// </summary>
        ...
        /// </remarks>
        public TdServerRetryingExecutionStrategy(
        ...
        protected override bool ShouldRetryOn(Exception exception)
        {
            ...
            return TdServerTransientExceptionDetector.ShouldRetryOn(exception);
        }
        ...
        {
            if (exception is TdException sqlException)
            {
                foreach (TdError err in sqlException.Errors)
                {
                    switch (err.Number)
