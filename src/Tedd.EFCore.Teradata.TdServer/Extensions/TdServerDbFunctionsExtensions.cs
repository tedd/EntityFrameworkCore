...
namespace Tedd.EFCore.Teradata
{
    ...
    /// </summary>
    public static class TdServerDbFunctionsExtensions
    {
        // [Tedd] TODO: Needs a lot of fixing
        ...
        {
            throw new InvalidOperationException(TdServerStrings.FreeTextFunctionOnClient);
        }
        ...
        {
            throw new InvalidOperationException(TdServerStrings.ContainsFunctionOnClient);
        }
