...
namespace Tedd.EFCore.Teradata.TdServer.Storage.Internal
{
    ...
    /// </summary>
    public class TdServerExecutionStrategy : IExecutionStrategy
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public TdServerExecutionStrategy([NotNull] ExecutionStrategyDependencies dependencies)
        {
            ...
            Func<DbContext, TState, ExecutionResult<TResult>> verifySucceeded)
        {
            ...
            catch (Exception ex) when (ExecutionStrategy.CallOnWrappedException(ex, TdServerTransientExceptionDetector.ShouldRetryOn))
            {
                throw new InvalidOperationException(TdServerStrings.TransientExceptionDetected, ex);
            }
        }
