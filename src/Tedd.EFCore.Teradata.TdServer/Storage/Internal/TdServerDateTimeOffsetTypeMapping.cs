...
namespace Tedd.EFCore.Teradata.TdServer.Storage.Internal
{
    ...
    /// </summary>
    public class TdServerDateTimeOffsetTypeMapping : DateTimeOffsetTypeMapping
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public TdServerDateTimeOffsetTypeMapping(
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        protected TdServerDateTimeOffsetTypeMapping(RelationalTypeMappingParameters parameters)
            : base(parameters)
        {
        }
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new TdServerDateTimeOffsetTypeMapping(parameters);
