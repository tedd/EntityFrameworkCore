...
namespace Tedd.EFCore.Teradata.TdServer.Storage.Internal
{
    ...
    /// </summary>
    public class TdServerUdtTypeMapping : RelationalTypeMapping
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        protected TdServerUdtTypeMapping(
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new TdServerUdtTypeMapping(parameters, LiteralGenerator, UdtTypeName);
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public static TdServerUdtTypeMapping CreateSqlHierarchyIdMapping(Type udtType)
            => new TdServerUdtTypeMapping(
                udtType,
                "hierarchyid",
                v => Expression.Call(
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public static TdServerUdtTypeMapping CreateSqlSpatialMapping(Type udtType, string storeName)
            => new TdServerUdtTypeMapping(
                udtType,
                storeName,
                v =>
