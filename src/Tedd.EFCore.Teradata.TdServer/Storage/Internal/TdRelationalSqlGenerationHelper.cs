...
namespace Tedd.EFCore.Teradata.TdServer.Storage.Internal
{
    /// <summary>
        ...
        ///     </para>
        /// </summary>
        public class TdRelationalSqlGenerationHelper : ISqlGenerationHelper
        {
            /// <summary>
            ///     Initializes a new instance of the this class.
            /// </summary>
            /// <param name="dependencies"> Parameter object containing dependencies for this service. </param>
            public TdRelationalSqlGenerationHelper([NotNull] RelationalSqlGenerationHelperDependencies dependencies)
            {
