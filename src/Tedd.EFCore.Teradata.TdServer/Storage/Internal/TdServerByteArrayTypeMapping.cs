...
namespace Tedd.EFCore.Teradata.TdServer.Storage.Internal
{
    ...
    /// </summary>
    public class TdServerByteArrayTypeMapping : ByteArrayTypeMapping
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public TdServerByteArrayTypeMapping(
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        protected TdServerByteArrayTypeMapping(RelationalTypeMappingParameters parameters)
            : base(parameters)
        {
        }
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new TdServerByteArrayTypeMapping(parameters);
