...
using Microsoft.EntityFrameworkCore.TdServer.Internal;
...
namespace Tedd.EFCore.Teradata.TdServer.Internal
{
    ...
    /// </summary>
    public static class TdServerLoggerExtensions
    {
        /// <summary>
        ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
        ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
        ...
        {
            var definition = TdServerResources.LogDefaultDecimalTypeColumn(diagnostics);
        ...
        public static void ByteIdentityColumnWarning(
            ...
            [NotNull] IProperty property)
        {
            var definition = TdServerResources.LogByteIdentityColumn(diagnostics);
        ...
        {
            var definition = TdServerResources.LogFoundColumn(diagnostics);
        ...
        {
            var definition = TdServerResources.LogFoundForeignKey(diagnostics);
        ...
        {
            var definition = TdServerResources.LogFoundDefaultSchema(diagnostics);
        ...
        {
            var definition = TdServerResources.LogFoundTypeAlias(diagnostics);
        ...
        public static void PrimaryKeyFound(
            ...
            [NotNull] string tableName)
        {
            var definition = TdServerResources.LogFoundPrimaryKey(diagnostics);
        ...
        public static void UniqueConstraintFound(
            ...
            [NotNull] string tableName)
        {
            var definition = TdServerResources.LogFoundUniqueConstraint(diagnostics);
        ...
        public static void IndexFound(
            ...
            bool unique)
        {
            var definition = TdServerResources.LogFoundIndex(diagnostics);
        ...
        {
            var definition = TdServerResources.LogPrincipalTableNotInSelectionSet(diagnostics);
        ...
        public static void ForeignKeyPrincipalColumnMissingWarning(
            ...
            [NotNull] string principalTableName)
        {
            var definition = TdServerResources.LogPrincipalColumnNotFound(diagnostics);
        ...
        {
            var definition = TdServerResources.LogMissingSchema(diagnostics);
        ...
        public static void MissingTableWarning(
            ...
            [CanBeNull] string tableName)
        {
            var definition = TdServerResources.LogMissingTable(diagnostics);
        ...
        {
            // No DiagnosticsSource events because these are purely design-time messages
            var definition = TdServerResources.LogFoundSequence(diagnostics);
        ...
        public static void TableFound(
            ...
            [NotNull] string tableName)
        {
            var definition = TdServerResources.LogFoundTable(diagnostics);
        ...
        public static void ReflexiveConstraintIgnored(
            ...
            [NotNull] string tableName)
        {
            var definition = TdServerResources.LogReflexiveConstraintIgnored(diagnostics);
